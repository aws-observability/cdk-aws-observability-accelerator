...
import { CreateIAMRoleStack, CreateIAMRoleStackProps } from './CreateIAMRoleStack';
...
export class PipelineMultiEnvMonitoring {
    ...
    async buildAsync(scope: Construct) {
        ...
        // const AMGTrustRoleStackProps: CreateIAMRoleNestedStackProps = {
        ...
        const pipeline = blueprints.CodePipelineStack.builder()
            ...
            const SampleStackProps: CreateIAMRoleStackProps = {
                env: {account: context.pipelineEnv.account as string},
                roleName: "AMPInfoForTrustedMonAccRole",
                trustArn: "arn:aws:iam::535548867000:root",
                actions: [
                    "aps:ListWorkspaces",
                    "aps:DescribeWorkspace",
                    "ssm:GetParameter",
