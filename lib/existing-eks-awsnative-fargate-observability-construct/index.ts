import { FargateClusterProvider, ImportClusterProvider,utils } from '@aws-quickstart/eks-blueprints';
import * as blueprints from '@aws-quickstart/eks-blueprints';
import { ObservabilityBuilder } from '../common/observability-builder';
import * as cdk from "aws-cdk-lib";
import * as eks from 'aws-cdk-lib/aws-eks';

export default class ExistingEksAwsNativeFargateObservabilityConstruct {
    async buildAsync(scope: cdk.App, id: string) {
        ...
        ObservabilityBuilder.builder()
            .account(account)
            .region(region)
            .addExistingClusterObservabilityBuilderAddOns("fargate")
