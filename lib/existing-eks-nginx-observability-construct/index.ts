...
import { GrafanaOperatorSecretAddon } from '../existing-eks-opensource-observability-construct/grafanaoperatorsecretaddon';
...
export default class ExistingEksNginxConstruct {
    async buildAsync(scope: cdk.App, id: string) {
        ...
        const ampWorkspaceArn = (blueprints.getNamedResource(ampWorkspaceName) as unknown as amp.CfnWorkspace).attrArn;
        ...
        const addOns: Array<blueprints.ClusterAddOn> = [
            ...
            new NginxPrometheusAddon({
                ampWorkspaceArn: ampWorkspaceArn,
                grafanaDashboardUrl: amgEndpointUrl,
            }),
        ];
